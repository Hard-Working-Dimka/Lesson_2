...
print('\n', translit(num2words(78), 'ru'), ' --- 78', sep='')
print(translit(num2words(15), 'ru'), '--- 15')
print(translit(num2words(3), 'ru'), '--- 3')
print(translit(num2words(40), 'ru'), '--- 40')
print(translit(num2words(8), 'ru'), '--- 8')